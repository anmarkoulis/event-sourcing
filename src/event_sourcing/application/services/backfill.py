...
from ..commands.salesforce import BackfillEntityTypeCommand, CreateClientCommand
...
class BackfillService:
    ...
    async def _backfill_page(self, entity_name: str, page: int, page_size: int) -> bool:
        ...
        for entity in entities_page.results:
            ...
            logger.info(f"Created backfill command for {entity_name} {entity['Id']}")
    ...
    async def trigger_backfill(self, aggregate_id: str, aggregate_type: str) -> None:
        ...
        if entity:
            ...
            # In a real implementation, this would be sent to a command bus
            logger.info(f"Created backfill command for {aggregate_type} {aggregate_id}")
    
    def _create_creation_command(self, entity: dict, entity_name: str) -> CreateClientCommand:
        ...
        raise NotImplementedError(f"Backfill not implemented for entity type: {entity_name}")
