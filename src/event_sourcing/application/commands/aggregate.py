...
class ReconstructAggregateCommand(Command):
    ...
    @classmethod
    def create(cls, aggregate_id: str, aggregate_type: str, entity_name: str,
               metadata: Optional[Dict[str, Any]] = None) -> "ReconstructAggregateCommand":
...
class AsyncReconstructAggregateCommand(Command):
    ...
    @classmethod
    def create(cls, aggregate_id: str, aggregate_type: str, entity_name: str,
               metadata: Optional[Dict[str, Any]] = None) -> "AsyncReconstructAggregateCommand":
...
class UpdateReadModelCommand(Command):
    ...
    @classmethod
    def create(cls, aggregate_id: str, aggregate_type: str, snapshot: Dict[str, Any],
               metadata: Optional[Dict[str, Any]] = None) -> "UpdateReadModelCommand":
...
class AsyncUpdateReadModelCommand(Command):
    ...
    @classmethod
    def create(cls, aggregate_id: str, aggregate_type: str, snapshot: Dict[str, Any],
               metadata: Optional[Dict[str, Any]] = None) -> "AsyncUpdateReadModelCommand":
...
class PublishSnapshotCommand(Command):
    ...
    @classmethod
    def create(cls, aggregate_id: str, aggregate_type: str, snapshot: Dict[str, Any], 
               event_type: str, metadata: Optional[Dict[str, Any]] = None) -> "PublishSnapshotCommand":
...
class AsyncPublishSnapshotCommand(Command):
    ...
    @classmethod
    def create(cls, aggregate_id: str, aggregate_type: str, snapshot: Dict[str, Any], 
               event_type: str, metadata: Optional[Dict[str, Any]] = None) -> "AsyncPublishSnapshotCommand":
