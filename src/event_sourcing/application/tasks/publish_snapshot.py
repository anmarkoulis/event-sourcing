...
from ..commands.aggregate import PublishSnapshotCommand
from ..commands.handlers.publish_snapshot import PublishSnapshotCommandHandler
...
async def publish_snapshot_async(
    ...
    logger.info(f"Successfully published snapshot asynchronously: {command_id}")
...
def publish_snapshot_task(
    ...
    logger.info(f"Starting Celery task for publish snapshot command: {command_id}")
    ...
    logger.info(f"Completed Celery task for publish snapshot command: {command_id}") 