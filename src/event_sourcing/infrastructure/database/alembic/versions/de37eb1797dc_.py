...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_client_aggregate_id'), 'client', ['aggregate_id'], unique=True)
    op.create_index(op.f('ix_client_id'), 'client', ['id'], unique=False)
    op.create_index(op.f('ix_client_name'), 'client', ['name'], unique=False)
    op.create_index(op.f('ix_client_parent_id'), 'client', ['parent_id'], unique=False)
    ...
    sa.Column('validation_info', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    op.create_index('idx_aggregate_events', 'event', ['aggregate_id', 'aggregate_type', 'timestamp'], unique=False)
    op.create_index('idx_event_source', 'event', ['source'], unique=False)
    op.create_index('idx_event_timestamp', 'event', ['timestamp'], unique=False)
    op.create_index('idx_event_type', 'event', ['event_type'], unique=False)
    op.create_index(op.f('ix_event_aggregate_id'), 'event', ['aggregate_id'], unique=False)
    op.create_index(op.f('ix_event_aggregate_type'), 'event', ['aggregate_type'], unique=False)
